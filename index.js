...
const client = new Client({
  phoneNumber: '33621719149', // Bot number
  prefix: [".", "/", "!"],
  fromMe: false, 
  owners: [
  // Owner 1
    { name: "VA", lid: "79020027922@lid", jid: "79020027922@s.whatsapp.net" },
  // Owner 2
    { name: "emam", lid: "201556853817@lid", jid: "20556853817@s.whatsapp.net" },
  // Owner 3
